...
client = commands.Bot(command_prefix="a2!")
status = cycle(["Minecraft, Roblox"])
...
async def rob(ctx,member : discord.Member):
    ...
    if bal[0]<100:
        await ctx.send('The victim doesnt have 100 dollars!! Leave that user alone')
        return
